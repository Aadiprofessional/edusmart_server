-- =============================================
-- COMPLETE CLEAN RECREATE - HANDLES ALL DEPENDENCIES
...
-- 13. ENABLE RLS AND CREATE SIMPLE, WORKING POLICIES
-- =============================================
ALTER TABLE public.profiles ENABLE ROW LEVEL SECURITY;
ALTER TABLE public.user_profiles ENABLE ROW LEVEL SECURITY;

-- PROFILES TABLE POLICIES (Service role has full access)
...
-- USER_PROFILES TABLE POLICIES (Service role has full access)
